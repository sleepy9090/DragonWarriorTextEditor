    ...
    public partial class FormDialog1 : Form
    {
        ...
        private void buttonUpdateText_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                backend.updateROMText(0x1C, textBoxRR4.Text, 0x8583, 0); //‘The +?~Thank you very much’
                ...
                backend.updateROMText(0x8, textBoxRR10.Text, 0x8664, 0); //‘The +?'
                backend.updateROMText(0x22, textBoxRR11.Text, 0x866E, 0); //‘Then I will buy thy + for % GOLD’
                ...
                backend.updateROMText(0x19, textBoxRR17.Text, 0x8723, 0); //@ chanted the spell of &.
                backend.updateROMText(0x1B, textBoxRR18.Text, 0x873D, 0); //@ cannot yet use the spell.
                ...
                backend.updateROMText(0x2A, textBoxRR23.Text, 0x87C8, 0); //@ sprinkled the Fairy Water over his body.
                ...
                backend.updateROMText(0x30, textBoxRR26.Text, 0x8845, 0); //@ threw The Wings of the Wyvern up into the sky.
                backend.updateROMText(0x21, textBoxRR27.Text, 0x8876, 0); //@ donned the scale of the dragon.
                backend.updateROMText(0x31, textBoxRR28.Text, 0x8898, 0); //Thou art already wearing the scale of the dragon.
                backend.updateROMText(0x1A, textBoxRR29.Text, 0x88CA, 0); //@ blew the Fairies’ Flute.
                backend.updateROMText(0x2A, textBoxRR30.Text, 0x88E5, 0); //Nothing of use has yet been given to thee.
                backend.updateROMText(0x1C, textBoxRR31.Text, 0x8910, 0); //@ put on the Fighter’s Ring.
                backend.updateROMText(0x2E, textBoxRR32.Text, 0x892D, 0); //@ adjusted the position of the Fighter’s Ring.
                backend.updateROMText(0x15, textBoxRR33.Text, 0x895C, 0); //@ held the + tightly.
                backend.updateROMText(0x24, textBoxRR34.Text, 0x8972, 0); //@ played a sweet melody on the harp.
                backend.updateROMText(0x1E, textBoxRR35.Text, 0x8997, 0); //@ put on the + and was cursed!
                backend.updateROMText(0x1B, textBoxRR36.Text, 0x89B8, 0); //Thy body is being squeezed.
                backend.updateROMText(0x1C, textBoxRR37.Text, 0x89D4, 0); //The + is squeezing thy body.
