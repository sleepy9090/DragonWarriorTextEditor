    ...
    public partial class FormDialog8 : Form
    {
        ...
        private void buttonUpdateText_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                backend.updateROMText(0xA, textBoxGG3.Text, 0xB76C, 0); //<Really?'~
                ...
                backend.updateROMText(0x1D, textBoxGG17.Text, 0xB9EC, 0); //Gwaelin said:~<Please, wait>~
                ...
                backend.updateROMText(0x45, textBoxGG23.Text, 0xBAC5, 0); //And thus the tale comes to an end$$~unless the dragons return again.~
                backend.updateROMText(0x41, textBoxGG24.Text, 0xBB11, 0); //<Will thou tell me now of thy deeds so they won゜t be forgotten?'~
                backend.updateROMText(0x3F, textBoxGG25.Text, 0xBB53, 0); //<Thy deeds have been recorded on the Imperial Scrolls of Honor>
                backend.updateROMText(0x28, textBoxGG26.Text, 0xBB94, 0); //<Dost thou wish to continue thy quest?'~
                ...
                backend.updateROMText(0x61, textBoxGG30.Text, 0xBC16, 0); //If you turn the power off first, the Imperial Scroll of Honor containing your deeds may be lost.~
        ...
        private void readRomText()
        {
            try
            {
                ...
                textBoxGG3.Text = backend.getROMText(0xA, 0xB76C, 0);
                ...
                textBoxGG17.Text = backend.getROMText(0x1D, 0xB9EC, 0);
                ...
                textBoxGG23.Text = backend.getROMText(0x45, 0xBAC5, 0);
                textBoxGG24.Text = backend.getROMText(0x41, 0xBB11, 0);
                textBoxGG25.Text = backend.getROMText(0x3F, 0xBB53, 0);
                textBoxGG26.Text = backend.getROMText(0x28, 0xBB94, 0);
                ...
                textBoxGG30.Text = backend.getROMText(0x61, 0xBC16, 0);
